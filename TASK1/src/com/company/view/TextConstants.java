...
public interface TextConstants {
    ...
    String TOYS_FOR_BABY_MSG = "toys.for.baby.data";
    String EMPTY_MSG = "empty.data";
    String LOW_MONEY_MSG = "no.money.on.acc";

    /*Messages for Toy class*/
    String PRICE_MSG = "price.data";
    String AGE_CATEGORY_MSG = "age.category.data";

    /*Messages for Doll class*/
    String TYPE_MSG = "type.data";
    String MATERIAL_MSG = "material.data";

    /*Messages for Cubes class*/
    String COUNT_MSG = "count.data";
    String DRAWING_MSG = "drawing.data";
